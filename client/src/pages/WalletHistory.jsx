      ...
      <div className="p-6 lg:p-10">
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm mb-10">
          <div className="flex justify-between items-center">
            <div>
              <p className="text-sm text-slate-500 mb-1">Available Balance</p>
              <h2 className="text-3xl font-bold text-slate-900">₹ {balance.toLocaleString("en-IN")}</h2>
            </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          {loading ? (
            ...
            <div className="divide-y divide-slate-100">
              {formatted.map((t) => (
                <div key={t.id} className="flex items-center justify-between p-6 hover:bg-slate-50 transition">
