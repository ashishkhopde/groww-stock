    ...
    <DashboardLayout>
      <div className="p-6 lg:p-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-500">Manage your personal details & security.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm lg:col-span-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  type="text"
                  value={user.name}
                  className="w-full mt-2 px-4 py-3 rounded-xl bg-slate-100 border border-slate-200 focus:bg-white focus:border-emerald-500 outline-none transition"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full mt-2 px-4 py-3 rounded-xl bg-slate-100 border border-slate-200 focus:bg-white outline-none transition"
                />
              </div>
            ...
            <div className="flex justify-end mt-8">
              <button className="px-6 py-3 bg-emerald-600 text-white rounded-xl font-semibold hover:bg-emerald-700 shadow-md shadow-emerald-600/20">
                Save Changes
              </button>
            </div>
          </div>
